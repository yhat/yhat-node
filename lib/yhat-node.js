    ...
    http.request(requestOptions, function(res) {
        ...
        res.on('end',function(){
            try {
                ...
                throw "Bad response from host: " + env;
            }
        ...
        throw "Could not connect to host: " + env;
    }).end();
}
        ...
        var req = http.request(requestOptions, function(res) {
            ...
            res.on('end', function() {
                try {
                    ...
                    fn(new Error("Bad respsonse from host: " + client.env));
                }
            });
        });
        req.on("error", function(e){
            fn(new Error("Could not connect to host: " + client.env));
        });
